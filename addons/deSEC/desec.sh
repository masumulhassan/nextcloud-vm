...
then
    ...
    curl_to_dir "https://raw.githubusercontent.com/masumulhassan/nextcloud-vm/master/addons/deSEC" "hook.sh" "$SCRIPTS"/deSEC
    chmod +x "$SCRIPTS"/deSEC/hook.sh
    curl_to_dir "https://raw.githubusercontent.com/masumulhassan/nextcloud-vm/master/addons/deSEC" ".dedynauth" "$SCRIPTS"/deSEC
