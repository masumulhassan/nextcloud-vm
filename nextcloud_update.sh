...
source <(curl -sL https://raw.githubusercontent.com/masumulhassan/nextcloud-vm/master/lib.sh)
...
then
    ...
    curl_to_dir https://raw.githubusercontent.com/masumulhassan/nextcloud-vm/master/network/asusnuc pn51.sh "$SCRIPTS"
